...
function getHospitals($num) {
    $str = "";
    $sql = "SELECT * FROM `clinics` where  `status`= '1'  order by rand() limit 0 ," . $num;
    $result = mysql_query($sql);
    while ($row = mysql_fetch_array($result)) {
        $str.='<li>' . $row['name'] . '</li>';
    }
        ...
        $outstr.= '
                                    <li>
                                        ...
                                        <div class="commentText">
                                            ...
                                            <span class="date sub-text">on ' . date('m-d-Y g:i A', strtotime($row['created'])) . '</span>
...
$str='<div class="content" >'.getUserNameAndAddressById($userdata).'
                    <div class="div-pic-content">' .$details['description'] .'
                         <div class="div-like">
                        <ul>
                            <li id="likes' . $i . '"><a ';
