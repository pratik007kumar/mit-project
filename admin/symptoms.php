...
$_SESSION['imagepaths']=SITE_URL."uploades/symptoms";
?>
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            $show_page ="";
            $sql="SELECT * FROM `symptoms` where  status='1'  ORDER BY id DESC";
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-clock-o fa-fw"></i> Symptoms
                        ...
                        <div class="panel-body">
                            ...
                            <button class="btn btn-info" data-toggle="modal"  data-target="#add" style="margin: 10px 0px; "><i class="fa fa-plus"></i> Symptoms</button>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped">
                                    ...
                                    for ($i = $start; $i < $end; $i++) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo  getCategoryNameById('symptoms',mysql_result($result, $i,'category') );?></td>
                                            <td><?=mysql_result($result, $i,'likes' );?></td>
                                            <td><?=mysql_result($result, $i,'stars' );?></td>
                                            <td>
                                                <button class="btn btn-info" onclick="symptomsEditform('<?=$id;?>')" title="Edit" > <i class="fa fa-edit"></i> </button>
                                                <button class="btn btn-danger" onclick="symptomsDelete('<?=$id;?>')" title="Delete"> <i class="fa fa-trash-o"></i> </button>
                                            </td>
                                ...
                                ?>
                                <li><a href="clinics.php?all=1"> All </a></li>
                                <?php
                                echo "</ul></div>";
                                ?>
                            </div>
...
<div class="modal fade bs-example-modal-sm" id="add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog " style="width: 80% !important;">
        ...
        <div class="modal-content">
            <form method="post"  id="addsymptomsfrm" action="ajax/symptomsAdd.php"   enctype="multipart/form-data">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="control-group ">
                                <div class="controls">
                                    ...
                                    <input name="name"  class="form-control" id="name" type="text" placeholder="Symptoms Name"   required>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="control-group ">
                                <div class="controls">
                                    <select  class="form-control" name="category" id="category" required>
                                        <?php echo getAllCategory('symptoms');?>
                                    </select>
...
<!--                                    <script type="text/javascript" src="--><?php //echo SITE_URL;?><!--admin/ck/kcfinder-3.12/ckfinder.js"></script>-->
                                    <textarea id="editor1" name="description" rows="5" cols="80"> </textarea>
...
<div class="modal fade bs-example-modal-sm" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog " style="width: 80% !important;">
        ...
        <div class="modal-content">
            <form method="post"  id="clinicsUpdateForm" action="ajax/symptomsUpdate.php"  enctype="multipart/form-data"  >
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">
                        <span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                    <h4 class="modal-title" id="myModalLabel">Update Clinics/Hospitals</h4>
                </div>
