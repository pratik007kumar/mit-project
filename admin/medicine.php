...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            $show_page ="";
            $sql="SELECT * FROM `medicine` where  status='1'  ORDER BY id DESC";
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-clock-o fa-fw"></i>  Medicine
                        ...
                        <div class="panel-body">
                            ...
                            <button class="btn btn-info" data-toggle="modal"  data-target="#addStore" style="margin: 10px 0px; "><i class="fa fa-plus"></i> Add Medicine</button>
                            ...
                            <a href="lib/medicine.xlsx" target="_blank" class="btn btn-success "     style="margin: 10px 0px; "><i class="fa fa-download"></i> Download Sample Excel File </a>
                                ...
                                <table class="table table-bordered table-hover table-striped">
                                    ...
                                    for ($i = $start; $i < $end; $i++) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo  mysql_result($result, $i,'company') ;?></td>
                                            <td><?php echo  mysql_result($result, $i,'description');?></td>
                                            <td><?=mysql_result($result, $i,'likes' );?></td>
                                            <td><?=mysql_result($result, $i,'stars' );?></td>
                                            <td>
                                                <button class="btn btn-info" onclick="midicineeditform('<?=$id;?>')" title="Edit" > <i class="fa fa-edit"></i> </button>
                                                <button class="btn btn-danger" onclick="midicinedelete('<?=$id;?>')" title="Delete"> <i class="fa fa-trash-o"></i> </button>
                                            </td>
...
<div class="modal fade bs-example-modal-sm" id="addStore" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog " style="width: 500px;">
        ...
        <div class="modal-content">
            <form method="post"  id="addmedicine"  name="addmedicine" action="#"  onsubmit=" return medicineAdd() " >
                ...
                <div class="modal-body form-horizontal">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="control-group ">
                                <div class="controls">
                                    ...
                                    <input name="name"  class="form-control" id="name" type="text" placeholder="Medicine Name"   required>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="control-group ">
                                <div class="controls">
                                    <select  class="form-control" name="category" id="category" required>
                                        <?php echo getAllCategory('medicine');?>
                                    </select>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="control-group ">
                                <div class="controls">
                                    <input name="company" class="form-control" id="company" type="text" placeholder="Company"  >
                                </div>
                            </div>
                        </div>
...
<div class="modal fade bs-example-modal-sm" id="update" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog " style="width: 500px;">

        <div class="modal-content">
            <form method="post"  id="updatemedicine" action="#"  onsubmit=" return medicineUpdate() " >
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                    <h4 class="modal-title" id="myModalLabel">Update Medicine</h4>
                </div>
                <div class="modal-body form-horizontal" id="updatemedicine-div">
...
<div class="modal fade bs-example-modal-sm" id="updateExls" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog " style="width: 500px;">
        ...
        <div class="modal-content">
            <form method="post"  id="elx" action="phpComponent/medicineExlsUpload.php" enctype="multipart/form-data"  >
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
